...
W3 = tf.Variable(tf.random_normal([3, 3, 64, 128], stddev=0.01))  # 이전과 달리 Convolutional layer을 하나 더 늘림
#    Conv      ->(?, 7, 7, 128)
#    Pool      ->(?, 4, 4, 128)
...
W4 = tf.get_variable("W4", shape=[128 * 4 * 4, 625],  # fully-connected layer을 하나 더 늘림, dropout도 사용
